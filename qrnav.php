    ...
    <div class="col-md-6 col-md-offset-2">
              ...
              <div class="box box-widget">
                ...
                <div class="box-body">
                  ...
                  <hr>
                  <p> Student Network QR Navigation System</p>
                  </center>
                </div>
                <!-- /.box-body -->
            ...
            <div class="col-md-4" id="res" style="display:none;">
                      <!-- Widget: user widget style 1 -->
                      <div class="box box-widget widget-user-2">
                        <!-- Add the bg color to the header using any of the bg-* classes -->
                        <div class="widget-user-header bg-yellow">
                          <div class="widget-user-image">
                            <img class="img-circle" height="30px" width="30px" src="images/users/default.jpg" alt="User Avatar">
                          </div>
                          <!-- /.widget-user-image -->
                          <h3 class="widget-user-username" id="namebox"></h3>
                        </div>
                        <div class="box-footer no-padding">
                          <ul class="nav nav-stacked">
                            <li><a href="#" id="subbox"></a></li>
                          </ul>
                        </div>
                      </div>
                      <!-- /.widget-user -->
